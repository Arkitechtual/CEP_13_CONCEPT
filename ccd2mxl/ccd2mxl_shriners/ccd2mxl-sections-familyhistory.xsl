...
<xsl:stylesheet version="2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema"
    ...
    <xsl:template match="/">
        ...
        <xsl:variable name="order-name"><xsl:text>Family History</xsl:text></xsl:variable>
        <xsl:variable name="order-code"><xsl:text>10157-6</xsl:text></xsl:variable>
        ...
        <xsl:variable name="report-code">
            <xsl:choose>
                ...
                <xsl:otherwise><xsl:text>10157-6</xsl:text></xsl:otherwise>
            </xsl:choose>
        </xsl:variable>
        ...
        <xsl:variable name="report-name">
            <xsl:choose>
                ...
                <xsl:otherwise><xsl:text>Family History</xsl:text></xsl:otherwise>
            </xsl:choose>
        </xsl:variable>
        ...
        <xsl:variable name="source">
            <xsl:call-template name="get-source-tag">
                ...
                <xsl:with-param name="author-tag"/>
            </xsl:call-template>
        </xsl:variable>
