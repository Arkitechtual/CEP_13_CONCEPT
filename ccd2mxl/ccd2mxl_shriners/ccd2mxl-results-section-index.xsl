<?xml version="1.0" encoding="UTF-8"?> <xsl:stylesheet version="2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema"
    ...
    <xsl:template match="/">
        <xsl:call-template name="build-section-labs-results">
            <xsl:with-param name="organizer"
                            select="./entry/organizer[(templateId/@root ='2.16.840.1.113883.10.20.1.32' and code/@code!='46680005' and 
code/@code!='363680008' and code/@code!='19851009' and code/@code!='53807006' and code/@code!='108257001' and code/@code!='373942005' and 
code/@code!='371526002') or (code/@codeSystem='2.16.840.1.113883.6.12') or (code/@code='252275004') or (code/@code='275711006') or
                                (code/@code='108257001') or (templateId/@root = '2.16.840.1.113883.10.20.22.4.1') or (code/@code='68793005') or 
(code/@code='59524001') or (code/originalText='URINALYSIS') or
                                (code/@nullFlavor='OTH') or (code/@nullFlavor='UNK') or (code/@code='OTH') or 
(code/@codeSystem='2.16.840.1.113883.6.96' and (code/@code!='46680005' and code/@code!='363680008' and code/@code!='19851009' and 
code/@code!='53807006' and code/@code!='108257001' and code/@code!='373942005' and code/@code!='371526002'))]" />
        </xsl:call-template>
        <!-- Call this again to get procedure tags from Results section.  These are orders -->
        <xsl:call-template name="build-section-labs-results">
            <xsl:with-param name="organizer"
                            select="./entry/procedure[(templateId/@root = '2.16.840.1.113883.10.20.1.32') or (templateId/@root = 
'2.16.840.1.113883.10.20.1.29') or (code/@codeSystem='2.16.840.1.113883.6.12') or (code/@code='252275004') or (code/@code='275711006') or
                                (code/@code='108257001') or (code/@code='68793005') or (code/@code='59524001') or (code/originalText='URINALYSIS') or
                                (code/@nullFlavor='OTH') or (code/@nullFlavor='UNK') or (code/@code='OTH') or 
(code/@codeSystem='2.16.840.1.113883.6.96' and (code/@code!='46680005' and code/@code!='363680008' and code/@code!='19851009' and 
code/@code!='53807006' and code/@code!='108257001' and code/@code!='373942005' and code/@code!='371526002'))]" />
        </xsl:call-template>
        <xsl:call-template name="build-section-micro">
            <xsl:with-param name="organizer"
                            select="./entry/organizer[(code/@code='19851009') or (templateId/@root = '2.16.840.1.113883.10.20.22.4.1') or 
(code/@code='630-4')]"/>
        </xsl:call-template>
        ...
        <xsl:call-template name="build-section-results">
            <xsl:with-param name="organizer"
                            select="./entry/organizer[(code/@code='363679005') or (code/@code='363680008')
                                ...
                                or (code/@code='77343006') or (code/@code='40701008') or (code/@code='radiology') or (code/@code='24727-0') or 
(code/@code='74022')or (code/@code='74220')]"/>
        ...
        <xsl:call-template name="build-section-results">
            <xsl:with-param name="organizer"
                            select="./entry/organizer[(code/@code='other-reports') or (code/@code='371526002') or (code/@code='371530004') or 
(code/@code='99241')]"/>
