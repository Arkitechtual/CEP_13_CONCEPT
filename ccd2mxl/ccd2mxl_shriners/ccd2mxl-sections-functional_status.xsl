...
<xsl:stylesheet version="2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema"
    ...
    <xsl:template match="/">
        ...
        <xsl:variable name="order-name"><xsl:text>Functional Status</xsl:text></xsl:variable>
        <xsl:variable name="order-code"><xsl:text>47420-5</xsl:text></xsl:variable>
        ...
        <xsl:variable name="report-code">
            <xsl:choose>
                ...
                <xsl:otherwise><xsl:text>47420-5</xsl:text></xsl:otherwise>
            </xsl:choose>
        </xsl:variable>
        ...
        <xsl:variable name="report-name">
            <xsl:choose>
                ...
                <xsl:otherwise><xsl:text>Functional Status</xsl:text></xsl:otherwise>
            </xsl:choose>
        </xsl:variable>
        ...
        <xsl:if test="normalize-space($report-text)!=''">
            <xsl:element name="result">
                <xsl:element name="SUB_TYPE">
                    <xsl:text>functional-status</xsl:text>
                </xsl:element>
