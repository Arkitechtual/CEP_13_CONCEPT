...
<xsl:stylesheet version="2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema"
    ...
    <xsl:template match="/">
        ...
        <xsl:variable name="order-name"><xsl:text>Plan of Care</xsl:text></xsl:variable>
        <xsl:variable name="order-code"><xsl:text>18776-5</xsl:text></xsl:variable>
        ...
        <xsl:variable name="report-code">
            <xsl:choose>
                ...
                <xsl:otherwise><xsl:text>18776-5</xsl:text></xsl:otherwise>
            </xsl:choose>
        </xsl:variable>
        ...
        <xsl:variable name="report-name">
            <xsl:choose>
                ...
                <xsl:otherwise><xsl:text>Plan of Care</xsl:text></xsl:otherwise>
            </xsl:choose>
        </xsl:variable>
        ...
        <xsl:element name="result">
            <xsl:element name="SUB_TYPE">
                <xsl:text>plan-of-care</xsl:text>
            </xsl:element>
