...
<xsl:stylesheet version="2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema"
    ...
    <xsl:template match="/">
        ...
        <xsl:variable name="order-name"><xsl:text>Assessment and Plan</xsl:text></xsl:variable>
        <xsl:variable name="order-code"><xsl:text>51847-2</xsl:text></xsl:variable>
        ...
        <xsl:variable name="report-code">
            <xsl:choose>
                ...
                <xsl:otherwise><xsl:text>51847-2</xsl:text></xsl:otherwise>
            </xsl:choose>
        </xsl:variable>
        ...
        <xsl:variable name="report-name">
            <xsl:choose>
                ...
                <xsl:otherwise><xsl:text>Assessment and Plan</xsl:text></xsl:otherwise>
            </xsl:choose>
        </xsl:variable>
        ...
        <xsl:if test="normalize-space($report-text) !=''">
            <xsl:element name="result">
                <xsl:element name="SUB_TYPE">
                    <xsl:text>clinical-documents</xsl:text>
                </xsl:element>
                ...
                <xsl:element name="DATA_TYPE">
                    <xsl:text>assessment-plan</xsl:text>
                </xsl:element>
